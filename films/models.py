...
class FilmAndGenre(SoftManagedModel):
...
class FilmRole(SoftManagedModel):
...
class FilmAndPerson(SoftManagedModel):
...
class ProductionCompany(SoftManagedModel):
...
class FilmAndProductionCompany(SoftManagedModel):
    record_id = models.AutoField(primary_key=True, verbose_name="Record ID")
...
class Country(SoftManagedModel):
...
class FilmAndCountry(SoftManagedModel):
...
class Language(SoftManagedModel):
...
class FilmAndLanguage(SoftManagedModel):
    record_id = models.AutoField(primary_key=True)

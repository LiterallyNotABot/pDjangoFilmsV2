...
DATABASES = {
    'default': dj_database_url.parse(os.getenv("DATABASE_URL", "postgres://postgres:1234@localhost:5432/DjangoFilmsDB"))
}
...
if not DEBUG:
    ...
    STATICFILES_DIRS = []  # No debe haber dirs adicionales en producción
else:
